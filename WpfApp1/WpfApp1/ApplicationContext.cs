...
namespace WpfApp1
{
    class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
            ...
            mb.Entity<PriceList_Model>().HasMany(p => p.PurchaseItems).WithOne(p => p.Item).OnDelete(DeleteBehavior.SetNull);
            ...
            mb.Entity<PriceList_Model>().HasMany(p => p.SupplyItems).WithOne(p => p.Item).OnDelete(DeleteBehavior.SetNull);
